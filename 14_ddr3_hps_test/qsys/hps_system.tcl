...
# ---------------------------------------------------------------------------
# DDR3 HPS memory test system for DE10-Nano (Cyclone V 5CSEBA6U23I7)
#
# Identical to the 05_hps_led system — reuses the same HPS + LW bridge + LED
# PIO configuration.  The DDR3 controller is part of the HPS hard block and
# requires no additional Qsys components.
#
# Components:
...
# Reset the LED PIO from the HPS h2f_reset output
