/*
 * main.c — Nios V/m interrupt demo for the DE10-Nano board.
 *
 ...
 *     → Nios V/m platform IRQ receiver (platform_irq_rx) → irqNumber 1
 *     → ISR: button_isr()
 *
...
int main(void)
{
     ...
     * the first alt_ic_isr_register() call (the Nios V/m platform IRQ
