...
--------------------------------------------------------------------------------
-- Top-level wrapper for the Nios V/m interrupt demo on the DE10-Nano board.
--
-- Extends 04b_niosv_led: adds KEY[0] and KEY[1] push-button inputs that are
-- wired to the button_pio peripheral.  The Nios V/m firmware registers an ISR
...
begin
  ...
  -- Nios V/m system generated by Platform Designer
  niosv_system_inst : niosv_system
    port map (
