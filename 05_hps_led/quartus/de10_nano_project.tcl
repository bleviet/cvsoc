...
# ── Top-level entity ──────────────────────────────────────────────────────────
# VHDL wrapper that connects FPGA pins (fpga_clk1_50, key, led, hps_ddr3_*)
# to the Platform Designer system.  Using the generated QIP (not QSYS_FILE)
# prevents Quartus from extracting unpatched DDR3 soft-model files from its
# installation into db/ip/, which would cause Error 174068.
